...
namespace Super_przygoda
{
    ...
    { 
        ...
        {
            if(newlocation.ID >0 && newlocation.ID <2)
            {
            ...
            btnProsto.Visible = (playerHasBattery && newlocation.LocationPrzod != null);
            btnBack.Visible = (playerHasBattery && newlocation.LocationTył != null);
            btnPrawo.Visible = (playerHasBattery && newlocation.LocationPrawo != null);
            btnLewo.Visible = (playerHasBattery && newlocation.LocationLewo != null);
        ...
        private void btnUseSunSails_Click(object sender, EventArgs e)
        {
            ...
            var playerHasBattery = _player.CurrentBatteries > 0;
            var locationProsto = _player.CurrentLocation.LocationPrzod != null;
            var locationTyl = _player.CurrentLocation.LocationTył != null;
            var locationPrawo = _player.CurrentLocation.LocationPrawo != null;
            var locationLewo = _player.CurrentLocation.LocationLewo != null;

            btnProsto.Visible = (playerHasBattery && locationProsto) ;
            btnBack.Visible = (playerHasBattery && locationTyl);
            btnPrawo.Visible = (playerHasBattery && locationPrawo);
            btnLewo.Visible = (playerHasBattery && locationLewo);
